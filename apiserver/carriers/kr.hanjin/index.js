...
function parseStatus(s) {
  ...
  if(s.includes('배송출발')) return {id: 'out_for_delivery', text:'배송출발'}
...
function getTrack(trackId) {
  return new Promise((resolve, reject) => {
    ...
    axios.post('https://m.hanex.hanjin.co.kr/inquiry/incoming/resultWaybill', qs.stringify({
      div: 'B',
      show: 'true',
      wblNum: trackId
    })).then(res => {
