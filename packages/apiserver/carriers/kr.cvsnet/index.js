...
function getTrack(trackId) {
  return new Promise((resolve, reject) => {
    axios.get('https://www.cvsnet.co.kr/reservation-inquiry/delivery/index.do', {
      params: {
        dlvry_type: 'domestic',
        invoice_no: trackId,
        srch_type: '01',
      ...
      const information = document.querySelectorAll('.deliveryInfo3 table td')
      ...
      let shippingInformation = {
        from: {
          ...
          time: `${information[2].innerHTML}T${information[3].innerHTML.trim()}:00+09:00`,
        },
        to: {
          name: information[5].innerHTML,
          time: null,
        },
        state: (function getState(s, current) {
          let index
          s.forEach((e, i) => { if (e == currentState) index = i })
