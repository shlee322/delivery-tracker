...
function getTrack(trackId) {
  ...
  return new Promise((resolve, reject) => {
    axios.get('http://www.kunyoung.com/goods/goods_01.php', {
      params: {
        mulno: trackId
      },
      ...
      const error = document.querySelector('td[height="30"][align="center"][colspan="9"]:not(.subtxt1)')
      if(error) {
        return reject({
          code: 404,
      ...
      progresses.forEach(element => {
        ...
        shippingInformation.progresses.push({
          ...
          status: { id: tds[1].textContent.indexOf('배송완료') !== -1 ? 'delivered' : 'in_transit', text: tds[1].textContent }
        })
      })
